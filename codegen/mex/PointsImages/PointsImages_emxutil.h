/*
 * PointsImages_emxutil.h
 *
 * Code generation for function 'PointsImages_emxutil'
 *
 */

#ifndef POINTSIMAGES_EMXUTIL_H
#define POINTSIMAGES_EMXUTIL_H
...
/* End of code generation (PointsImages_emxutil.h) */
