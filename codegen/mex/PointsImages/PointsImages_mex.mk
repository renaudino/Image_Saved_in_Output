...
MAKEFILE = PointsImages_mex.mk

include PointsImages_mex.mki
...
SYS_INCLUDE += /I "$(START_DIR)\codegen\mex\PointsImages"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\PointsImages/%.c
	$(CC) $(CFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\PointsImages/%.cpp
	$(CC) $(CPPFLAGS) "$<"
