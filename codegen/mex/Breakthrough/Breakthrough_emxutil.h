/*
 * Breakthrough_emxutil.h
 *
 * Code generation for function 'Breakthrough_emxutil'
 *
 */

#ifndef BREAKTHROUGH_EMXUTIL_H
#define BREAKTHROUGH_EMXUTIL_H
...
/* End of code generation (Breakthrough_emxutil.h) */
