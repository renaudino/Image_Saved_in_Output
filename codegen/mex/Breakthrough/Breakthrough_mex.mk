...
MAKEFILE = Breakthrough_mex.mk

include Breakthrough_mex.mki
...
SRC_FILES =  \
	...
	Breakthrough_emxutil.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = Breakthrough
...
SYS_INCLUDE += /I "$(START_DIR)\codegen\mex\Breakthrough"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\Breakthrough/%.c
	$(CC) $(CFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\Breakthrough/%.cpp
	$(CC) $(CPPFLAGS) "$<"
