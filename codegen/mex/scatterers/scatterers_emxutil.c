 ...
 *
 * Code generation for function 'scatterers_emxutil'
 *
 */
...
void emxInit_real_T(const emlrtStack *sp, emxArray_real_T **pEmxArray, int32_T
                    b_numDimensions, const emlrtRTEInfo *srcLocation, boolean_T
                    doPush)
{
...
void emxInit_real_T3(const emlrtStack *sp, emxArray_real_T **pEmxArray, int32_T
                     b_numDimensions, const emlrtRTEInfo *srcLocation, boolean_T
                     doPush)
{
  emxArray_real_T *emxArray;
...
/* End of code generation (scatterers_emxutil.c) */
