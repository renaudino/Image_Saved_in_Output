                 ...
                 emxArray_real_T *points, real_T *number, emxArray_real_T *space)
{
  ...
  aa = 0;
  while (aa < 4) {
    if (f != (int32_T)muDoubleScalarFloor(f)) {
      emlrtIntegerCheckR2012b(f, &b_emlrtDCI, sp);
    }

    i = (int32_T)f;
    if (!((i >= 1) && (i <= 6))) {
      emlrtDynamicBoundsCheckR2012b(i, 1, 6, &b_emlrtBCI, sp);
    }

    if (b != (int32_T)muDoubleScalarFloor(b)) {
      emlrtIntegerCheckR2012b(b, &emlrtDCI, sp);
    }
  ...
  if (f != (int32_T)muDoubleScalarFloor(f)) {
    emlrtIntegerCheckR2012b(f, &d_emlrtDCI, sp);
  }

  i = (int32_T)f;
  if (!((i >= 1) && (i <= 6))) {
    emlrtDynamicBoundsCheckR2012b(i, 1, 6, &d_emlrtBCI, sp);
  }

  if (b != (int32_T)muDoubleScalarFloor(b)) {
    emlrtIntegerCheckR2012b(b, &c_emlrtDCI, sp);
  }
  ...
  ixstart = (int32_T)b;
  if (!((ixstart >= 1) && (ixstart <= i))) {
    emlrtDynamicBoundsCheckR2012b(ixstart, 1, i, &g_emlrtBCI, sp);
  }
  ...
  ixstart = (int32_T)b;
  if (!((ixstart >= 1) && (ixstart <= i))) {
    emlrtDynamicBoundsCheckR2012b(ixstart, 1, i, &h_emlrtBCI, sp);
  }
  ...
  if ((n == 0.0) || (n == 1.0)) {
    ...
    aa = (int32_T)b;
    if (!((aa >= 1) && (aa <= i))) {
      emlrtDynamicBoundsCheckR2012b(aa, 1, i, &k_emlrtBCI, sp);
    }

    i = wedges->size[0];
    aa = (int32_T)b;
    if (!((aa >= 1) && (aa <= i))) {
      emlrtDynamicBoundsCheckR2012b(aa, 1, i, &l_emlrtBCI, sp);
    }
    ...
    if (n > 1.0) {
      ...
      while (b_i <= n) {
        ...
        emlrtForLoopVectorCheckR2012b(0.0, 1.0, muDoubleScalarCeil(y) - 1.0,
          mxDOUBLE_CLASS, (int32_T)(d0 + 1.0), &f_emlrtRTEI, sp);
        aa = 0;
        while (aa <= (int32_T)(d0 + 1.0) - 1) {
          ...
          if ((vrot[0] < spacelimit[3]) && (vrot[0] > spacelimit[0]) && (vrot[1]
            ...
            i = number_sub - 1;
            if (!((i >= 1) && (i <= 10000))) {
              emlrtDynamicBoundsCheckR2012b(i, 1, 10000, &m_emlrtBCI, sp);
            }
      ...
      if (!((number_sub >= 1) && (number_sub <= 10000))) {
        emlrtDynamicBoundsCheckR2012b(number_sub, 1, 10000, &n_emlrtBCI, sp);
      }
