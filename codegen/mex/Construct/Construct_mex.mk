...
MAKEFILE = Construct_mex.mk

include Construct_mex.mki
...
MEX_FILE_NAME_WO_EXT = Construct
...
SYS_INCLUDE += /I "$(START_DIR)\codegen\mex\Construct"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\Construct/%.c
	$(CC) $(CFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\Construct/%.cpp
	$(CC) $(CPPFLAGS) "$<"
