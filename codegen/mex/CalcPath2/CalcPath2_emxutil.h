...
#ifndef CALCPATH2_EMXUTIL_H
#define CALCPATH2_EMXUTIL_H
...
extern void emxInit_boolean_T(const emlrtStack *sp, emxArray_boolean_T
  **pEmxArray, int32_T b_numDimensions, const emlrtRTEInfo *srcLocation,
  boolean_T doPush);
...
/* End of code generation (CalcPath2_emxutil.h) */
