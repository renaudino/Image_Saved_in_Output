  ...
  emlrtMsgIdentifier *msgId, emxArray_creal_T *ret)
{
  ...
  i15 = ret->size[0];
  ret->size[0] = iv9[0];
  emxEnsureCapacity(sp, (emxArray__common *)ret, i15, sizeof(creal_T),
                    (emlrtRTEInfo *)NULL);
...
const mxArray *c_emlrt_marshallOut(const emxArray_real_T *u)
{
  ...
  int32_T d_i;
  y = NULL;
  m4 = emlrtCreateNumericArray(4, *(int32_T (*)[3])u->size, mxDOUBLE_CLASS,
    mxREAL);
...
/* End of code generation (Masking_Olivier_global_mexutil.c) */
