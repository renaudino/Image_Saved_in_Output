...
MAKEFILE = Masking_Olivier_global_mex.mk

include Masking_Olivier_global_mex.mki


SRC_FILES =  \
	Masking_Olivier_global_mexutil.c \
	...
	Masking_Olivier_global_emxutil.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = Masking_Olivier_global
...
SYS_INCLUDE += /I "$(START_DIR)\codegen\mex\Masking_Olivier_global"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\Masking_Olivier_global/%.c
	$(CC) $(CFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\Masking_Olivier_global/%.cpp
	$(CC) $(CPPFLAGS) "$<"
