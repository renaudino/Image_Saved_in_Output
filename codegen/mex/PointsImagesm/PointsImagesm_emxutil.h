/*
 * PointsImagesm_emxutil.h
 *
 * Code generation for function 'PointsImagesm_emxutil'
 *
 */

#ifndef POINTSIMAGESM_EMXUTIL_H
#define POINTSIMAGESM_EMXUTIL_H
...
/* End of code generation (PointsImagesm_emxutil.h) */
