function CalcFEds_Image_Olivier ()
...
global Area DBIMAGES DSN emett eta FDS K lambda Lr Lt Mtrun Nblock NbrDSSlns Nbrimg Ninterac ...
       OutputDataFDS PDS PSLN ReceiveType recept RF RP TransmitType vnfaces wedges;
...
% temporary variables for Blocking
Temp3                              = zeros(3,1);

Mtrun                              = [];
Mtrun(1:Ninterac+1,1:Nblock*6,1:9) = zeros(Ninterac+1,Nblock*6,9);

Nbrimg                             = zeros(Ninterac+1,1);
