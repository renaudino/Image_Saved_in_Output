...
if (bk ~= 1)
   ...
   if mmask ~= 2
    ...
    if ((los.mask) ~= 1)
        ...
        OutputDataLos(1,:) = [emett(1),emett(2),emett(3),recept(1),recept(2),recept(3),recept(1),recept(2),recept(3),emett(1),emett(2),emett(3),dAtt, ...
                              real(Eout),imag(Eout),0,0];
    end
else
    Eout = complex(0,0);
    OutputDataLos(1,:) = [emett(1),emett(2),emett(3),recept(1),recept(2),recept(3),recept(1),recept(2),recept(3),emett(1),emett(2),emett(3),dAtt, ...
