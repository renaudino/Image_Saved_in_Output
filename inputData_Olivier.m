...
function inputData_Olivier (WedgesInput, outwedges)
...
for i = 1:Nblock
    ...
    DSFlag(i,1)     = WedgesInput(11,i);
    MSKFlag(i,1)    = WedgesInput(12,i);
    CEP(i,1)        = WedgesInput(13,i);
    Permitt(i,1)    = WedgesInput(14,i);
    Conduct(i,1)    = WedgesInput(15,i);
    Model(i,1)      = WedgesInput(16,i);
    Scoeff(i,1)     = WedgesInput(17,i);
    Lam(i,1)        = WedgesInput(18,i);
    Ar(i,1)         = WedgesInput(19,i);
    Aii(i,1)        = WedgesInput(20,i);
end
